...
const CRISES_DATA: Crisis[] = [
  ...
  },
  {
    ...
    period: '2026 (à juillet)',
    startYear: 2026,
    endYear: 2026,
    title: 'Choc Énergétique au Moyen-Orient',
    shortDescription: 'Perturbation des flux pétroliers via Ormuz, inflation relancée et resserrement monétaire de la BCE',
    fullDescription: 'Le conflit au Moyen-Orient perturbe les exportations d\'hydrocarbures via le détroit d\'Ormuz et provoque un choc énergétique mondial. Après une flambée au printemps, le pétrole se détend fortement en juin grâce à la reprise partielle des flux, mais reste très volatil en juillet. Face aux pressions inflationnistes, la BCE relève ses trois taux de 0,25 point en juin, puis les maintient en juillet. Le FMI estime désormais la croissance de la zone euro à 0,9% en 2026, pénalisée notamment par le renchérissement de l\'énergie.',
    severity: 'major',
    impacts: [
      { index: 'Pétrole Brent', change: '68-77 $/b en juillet', positive: false },
      { index: 'Taux dépôt BCE', change: '+0,25 pt', positive: false },
      { index: 'Croissance zone euro', change: '0,9% en 2026', positive: false },
      { index: 'Flux pétroliers du Golfe', change: 'reprise partielle', positive: true },
    ],
    keyFacts: [
      'La BCE relève le taux de dépôt à 2,25% le 11 juin, puis le maintient le 23 juillet 2026',
      'En juin, la production pétrolière mondiale reste inférieure de 9,4 millions de barils/jour à son niveau d\'avant-guerre',
      'Le FMI projette 0,9% de croissance en zone euro en 2026 et constate l\'arrêt de la désinflation mondiale',
    ]
  },
];
